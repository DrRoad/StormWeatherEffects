##-----------------------------------------------------------------------------
## Module.......: recodeTypes.R
## Author.......: Alex Pittendreigh
## Date.........: October 2014
## Description..: Recodes the values in the evtype column of the data frame.
##                NOTE: This file will not successfully run by instself as it 
##                      requires packages and dataframes to already be loaded
##------------------------------------------------------------------------------
