...
To start this process the values of the evtpe column in the data set will be recoded by a submodule called "recodeTypes.R'. This module will not be shown in this report due to its length. It can, however, be examanined in the .Rmd file located in my [Github repository](https://github.com/apittendreigh/StormWeatherEffects). A sampling of this code looks like...
